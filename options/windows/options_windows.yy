{
  ...
  "option_windows_company_info": "Crios Devs",
  "option_windows_product_info": "Created with GameMaker Studio 2",
  "option_windows_copyright_info": "Crios Devs",
  "option_windows_description_info": "A custom console command to use in real time in Game Maker Studio projects (without the need to use the engine and the project files)",
