...
if(_isNewWindowSizeSetted and _isResInfoShow ) {
	...
	draw_text(l_xx, l_yy,		"Display: " + string(_resDisplayWidth) + " x " + string(_resDisplayHeight) );
	...
	draw_text(l_xx, l_yy + 80,	"Base: " + string(_resBaseWidth) + " x " + string(_resBaseHeight ));
	draw_text(l_xx, l_yy + 100, "Aspect Ratio W/H: " + string(_resAspectRatio) );
	draw_text(l_xx, l_yy + 120, "Multiplier Offset GUI: " + string(_resGUIAspectOffset) );
